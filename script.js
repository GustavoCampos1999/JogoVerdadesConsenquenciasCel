...
function selecionarNivel(nivel) {
  if (nivel === "facil") {
   ...
   if (aguardandoPrenda) {
  // Limpa classes de animação anteriores (você já tem isso, ótimo!)
  animacao.classList.remove("animacao-verdade", "animacao-consequencia", "animacao-prenda");

  if (cumpriu) { 
    mensagem.textContent = "Você cumpriu a prenda! O jogo continua."; 
    animacao.textContent = "Você cumpriu a prenda!"; 
    ...
    animacao.textContent = "Você não pagou a prenda!"; 
